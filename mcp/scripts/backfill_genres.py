...
TITLE_EXCLUSIONS: dict[str, set[str]] = {
    ...
    "Batman: Arkham Asylum": {"metroidvania", "horror"},
    "Batman: Arkham City": {"metroidvania"},
    "Batman Arkham Knight": {"horror"},
    "Castlevania: Lords of Shadow 2": {"metroidvania", "horror"},
    ...
    # Horror tag manually removed — atmospheric/dark ≠ horror genre
    "DOOM": {"horror"},
    "DOOM II": {"horror"},
    "DOOM 64": {"horror"},
    "DOOM Eternal": {"horror"},
    "Mortal Kombat X": {"horror"},
    "Mortal Kombat 1": {"horror"},
    "Blasphemous": {"horror"},
    "Cabernet": {"horror"},
    "Disciples: Liberation": {"horror"},
    "Firewatch": {"horror"},
    "Ruined King: A League of Legends Story": {"horror"},
    "Scars Above": {"horror"},
    "Stray": {"horror"},
    "The Stanley Parable: Ultra Deluxe": {"horror"},
    "Vampyr": {"horror"},
    "The Painscreek Killings": {"horror"},
    "Warhammer: End Times - Vermintide": {"horror"},
    "Halo: The Master Chief Collection": {"horror"},
    "CONTROL": {"horror"},
    "Organ Trail": {"horror"},
    "Cognition: An Erica Reed Thriller": {"horror"},
    "Strange Brigade": {"horror"},
    "Don't Starve Together": {"horror"},
    "Vikings - Wolves of Midgard": {"horror"},
    "Beyond: Two Souls": {"horror"},
    "Black Mesa": {"horror"},
    "Atomic Heart": {"horror"},
    "Event[0]": {"horror"},
    "Don't Starve": {"horror"},
    "Painkiller Hell & Damnation": {"horror"},
    "Half-Life 2": {"horror"},
    "Valley": {"horror"},
    "The Room": {"horror"},
    "Legendary": {"horror"},
    "RAGE": {"horror"},
    "Half-Life: Source": {"horror"},
    "X-COM: Terror From the Deep": {"horror"},
    "Prototype": {"horror"},
    "Max Payne": {"horror"},
    "Dark Sector": {"horror"},
    "Prototype 2": {"horror"},
